...
const PublicProfile: React.FC<PublicProfileProps> = ({ 
  ...
  return (
    <div className="h-full bg-white flex flex-col overflow-y-auto pb-0 scrollbar-hide">
      ...
      <div className="relative w-full h-[280px] bg-black flex flex-col items-center justify-center overflow-hidden flex-shrink-0">
        <div className="absolute inset-0 opacity-10 pointer-events-none grayscale" style={{ backgroundImage: 'url("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png")', backgroundSize: 'cover' }}></div>
      ...
      <div className="px-6 pt-[64px] space-y-5 bg-white border-b border-gray-100 pb-0">
      ...
      {/* 6. Elogios Section */}
      <div className="px-6 pt-8 pb-0 bg-white">
      ...
      <div className="px-6 pt-10 pb-0 bg-white border-b border-gray-100">
        <h3 className="text-[22px] font-black text-black tracking-tighter mb-10">Ícones</h3>
      ...
      {/* 8. Compartilhe a sua história Section */}
