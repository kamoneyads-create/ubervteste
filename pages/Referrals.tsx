...
const Referrals: React.FC<ReferralsProps> = ({ onBack }) => {
  ...
  return (
    <div className="absolute inset-0 z-[6000] bg-white flex flex-col font-sans">
      {/* Scrollable Area */}
        ...
        {showInviteModal && (
          <>
            ...
            <motion.div 
              ...
              className="absolute bottom-0 left-0 right-0 bg-white z-[7001] rounded-t-[24px] px-6 pt-8 pb-0 flex flex-col items-center"
            >
              {/* Handle bar */}
