...
const Documents: React.FC<DocumentsProps> = ({ onBack, onViewAll }) => {
  return (
    <div className="h-full bg-white flex flex-col overflow-y-auto overflow-x-hidden">
      {/* Header Bar - Native iOS/Android App Style */}
      <div className="flex items-center justify-between px-5 pt-8 pb-0 sticky top-0 bg-white z-50">
