...
const Opportunities: React.FC<OpportunitiesProps> = ({ onBack }) => {
  ...
  return (
    <div className="absolute inset-0 z-[5000] bg-white overflow-y-auto transition-colors duration-300">
      {/* Header */}
      ...
      {/* Content */}
      <div className="px-5 pt-1 pb-0 scrollbar-hide">
        <div className="bg-white rounded-[20px] border border-gray-100 p-5 shadow-sm flex justify-between items-start active:scale-[0.98] transition-transform cursor-pointer">
          ...
          <div className="shrink-0 pt-0.5">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" className="text-black" xmlns="http://www.w3.org/2000/svg">
